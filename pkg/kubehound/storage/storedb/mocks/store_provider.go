...
// Write provides a mock function with given fields: ctx, model
func (_m *Provider) Write(ctx context.Context, model interface{}) error {
...
// Provider_Write_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Write'
type Provider_Write_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - model interface{}
func (_e *Provider_Expecter) Write(ctx interface{}, model interface{}) *Provider_Write_Call {
	return &Provider_Write_Call{Call: _e.mock.On("Write", ctx, model)}
}

func (_c *Provider_Write_Call) Run(run func(ctx context.Context, model interface{})) *Provider_Write_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1])
	})
	return _c
}

func (_c *Provider_Write_Call) Return(_a0 error) *Provider_Write_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Provider_Write_Call) RunAndReturn(run func(context.Context, interface{}) error) *Provider_Write_Call {
	_c.Call.Return(run)
	return _c
}
