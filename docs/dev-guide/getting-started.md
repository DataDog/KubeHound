...
The CI will draft a new release (not available publicly). **In order to finish the process, an admin has to to validate the draft from the [release page](https://github.com/DataDog/KubeHound/releases)**.
